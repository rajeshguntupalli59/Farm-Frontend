...
export const cancelMyOrder = (id) => customerApi.patch(`/customers/me/orders/${id}/cancel`)
...
// REVIEWS
export const getProductReviews = (productId) => axios.get(`${API_URL}/reviews/product/${productId}`)
export const addReview = (data) => customerApi.post('/reviews', data)
export const getAllReviews = () => api.get('/reviews')
export const hideReview = (id) => api.patch(`/reviews/${id}/hide`)
export const restoreReview = (id) => api.patch(`/reviews/${id}/restore`)

// BOOKINGS
export const placeBooking = (data) => customerApi.post('/bookings', data)
export const getMyBookings = () => customerApi.get('/bookings/me')
export const cancelBooking = (id) => customerApi.patch(`/bookings/me/${id}/cancel`)
